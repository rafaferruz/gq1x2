...
/**
 * El siguiente script muestra las imagenes referenciadas mediante su URL en un
 * array que debe llamarse Pic. Dicho array puede incluirse en un fichero .js
 * que debe cargarse en la página antes que este fichero zcommon.js o generarse
 * dinámicamente pero definiendo el array Pic y iniciándolo antes de la carga de
 * zcommon.js.
 * Created by Pierre Volpe
 *
 * Se inicializan unas variables de trabajo al cargar la página y provee una función
 * que debe ser llamada cuando se termina de cargar la página y que muestra un
